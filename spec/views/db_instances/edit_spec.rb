...
describe "/db_instances/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/db_instances/edit.html.erb"
    
    response.should have_tag("form[action=#{db_instance_path(@db_instance)}][method=post]") do
