...
describe "/versions/index.html.erb" do
  ...
  before do
    ...
    version_98.should_receive(:schema_version).and_return("2_23_3")
    version_98.should_receive(:deployed?).and_return(false)
    version_98.should_receive(:created?).and_return(true)
    ...
    version_99.should_receive(:schema_version).and_return("3_1_5")
    version_99.should_receive(:deployed?).and_return(false)
    version_99.should_receive(:created?).and_return(false)
