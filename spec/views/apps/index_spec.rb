...
describe "/apps/index.html.erb" do
  ...
  before(:each) do
    ...
    app_98.should_receive(:to_s).and_return("App1")
    ...
    app_99.should_receive(:to_s).and_return("App2")
    ...
    new_app.should_receive(:vc_path).and_return('')
  ...
  it "should render list of apps" do
    ...
    response.should have_tag("h3", "App1", 1)
    response.should have_tag("h3", "App2", 1)
  end
end
